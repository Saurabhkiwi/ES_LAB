...
unsigned long int temp1=0, temp2=0,i,j,result;
unsigned char flag1 =0, flag2 =0;
unsigned char msg[] = {"4454545"};
void lcd_write(void);
...
int main(void)
{
	...
	LPC_PINCON->PINSEL1=0x3<<28;
	LPC_GPIO0->FIODIR = 0xFF<<4 |DT_CTRL | RS_CTRL | EN_CTRL;
	flag1 =0;
	for (i=0; i<9;i++)
	{
